...
20.times do
    ...
    Doctor.create(
        ...
        email: Faker::Internet.email , specialty: special.sample(1),
        image_url: "https://t3.ftcdn.net/jpg/03/46/83/96/240_F_346839683_6nAPzbhpSkIpb8pmAwufkC7c5eD7wYws.jpg",
        years_experience: rand(1...35), mobile: Faker::PhoneNumber.phone_number,
         university: uni.sample(1) , hourly_rate: rand(30...150)
        )
end

puts "Done Seeding Doctor"
loc = ["Online", "In-Person"]
puts "Seeding Appointments"
5.times do
    Appointment.create(patient_id: p1.id, doctor_id: 1,
        appt_date_time: DateTime.now - (rand * 21) , duration: rand(1...3),
        appt_reason: "Lorem ipsum dolor sit amet",
        appt_summary: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
        location: loc.sample(1), prescription: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor",
        rating:  rand(3.5...5), total_cost: rand(30...1000)
    )
end
